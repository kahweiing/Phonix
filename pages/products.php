    ...
    <div class="container">
                    ...
                    <div class="item">
                        <article>
                            <figure>
                                ...
                                <form method="post"
                                      action="products.php?action=add&id=<?php echo $product["product_id"]; ?>&page=<?php echo $page ?>">
        ...
        <?php if (ceil($total_products / $num_results_on_page) > 0): ?>
            <ul class="pagination">
                ...
                <?php if ($page - 2 > 0): ?>
                    <li class="page"><a href="products.php?page=<?php echo $page - 2 ?>"><?php echo $page - 2 ?></a>
                    </li><?php endif; ?>
                <?php if ($page - 1 > 0): ?>
                    <li class="page"><a href="products.php?page=<?php echo $page - 1 ?>"><?php echo $page - 1 ?></a>
                    </li><?php endif; ?>
                ...
                <?php if ($page < ceil($total_products / $num_results_on_page) - 2): ?>
                    <li class="dots">...</li>
                    <li class="end"><a
                                href="products.php?page=<?php echo ceil($total_products / $num_results_on_page) ?>"><?php echo ceil($total_products / $num_results_on_page) ?></a>
                    </li>
                <?php endif; ?>
